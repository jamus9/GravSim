...
public class ParticleArrays {
	 ...
	 * @return
	 */
	public static ArrayList<Particle> getVerticalLine(Vec pos, Vec vel, double lenght, int number) {
	 ...
	 * @return
	 */
	public static ArrayList<Particle> getField(double x, double y, Vec center) {
		int n = 50;
